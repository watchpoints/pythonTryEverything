...
def interface_auo_upload_shipinhao(upload_type:str,out_path:str, bak_path:str):
    ...
    try:
        ...
        file_path, habit_name,habit_detail = learn_english_speak.interface_get_daily_englis_word_big()
...
def interface_not_quit_auto_shipinhao_window():
    ...
    if sys == "Windows":
        ...
        cookies_path = r"/Users/wangchuanyi/mp4/etc/shipinhao_xiaohao.json"
    else:
        cookies_path = r"/root/bin/shipinhao_xiaohao.json"
    try:
        autoupload = CMyShipinhao(cookies_path, login_url, upload_picture_url,upload_mp4_url)
        ...
        while True:
            # 发布图文
            autoupload.auto_upload_picture(autoupload.page,file_path_list, habit_name,habit_detail)
            # 发布视频
            steps = 20*60*60
            time.sleep(steps)
