...
if __name__ == '__main__':
    #start_url = 'https://api.zsxq.com/v1.10/groups/88855282125442/topics?scope=digests&count=20'
    start_url = 'https://api.zsxq.com/v2/groups/222528158541/topics?scope=digests&count=20'
