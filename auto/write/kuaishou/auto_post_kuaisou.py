...
def interface_auo_upload_mp4_kuaishou(mp4_file_path):
    
    try:
        sys = platform.system()
        if sys == "Windows":
            coook_path = r"D:\mp4\etc\kuaishou_small.json"
            login_url = "https://cp.kuaishou.com/profile"
            upload_url = "https://cp.kuaishou.com/article/publish/video"
        else:
            coook_path = r"/root/bin/kuaishou_small.json"
            login_url = "https://cp.kuaishou.com/profile"
            upload_url = "https://cp.kuaishou.com/article/publish/video"
        autoupload = MyKuaishou(coook_path,login_url,upload_url)
...
if __name__ == '__main__':
    ...
    interface_auo_upload_mp4_kuaishou("")
