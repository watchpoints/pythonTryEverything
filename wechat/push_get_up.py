...
def get_access_token():
    try:
        ...
        appsecret = "60293d18e202d3216dfd7145805c3820"
...
def get_life_task():
    return spider_data.get_up_everyday()
...
def markdown_to_wechat():
    # 1 access_token
    # myclient = NewClient()
    # # https://zhuanlan.zhihu.com/p/589853397
    # try:
    #     # https://developers.weixin.qq.com/doc/offiaccount/Basic_Information/Get_access_token.html
    #     # access_token
    #     my_token = myclient.grant_token()
    #     print(my_token)
    # except Exception as e:
    #     print(e)
    #     return False
...
if __name__ == '__main__':
    ...
    print("程序耗时{:.2f}秒.".format(end_time - start_time))
